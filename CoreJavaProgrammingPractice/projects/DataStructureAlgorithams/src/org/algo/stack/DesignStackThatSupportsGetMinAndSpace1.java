...
If x is less than minEle, insert (2*x – minEle) into the stack and make minEle equal to x. 
	For example, let previous minEle was 3. Now we want to insert 2. We update minEle as 2 
	and insert 2*2 – 3 = 1 into the stack.
 ...
 *
 */
public class DesignStackThatSupportsGetMinAndSpace1 {

	private java.util.Stack<Integer> s = new java.util.Stack<Integer>();
    private Integer minEle;
 
	public static void main(String[] args)
	{
		DesignStackThatSupportsGetMinAndSpace1 s = new DesignStackThatSupportsGetMinAndSpace1();
	    s.push(3);
	    s.push(5);
	    s.getMin();
	    s.push(2);
