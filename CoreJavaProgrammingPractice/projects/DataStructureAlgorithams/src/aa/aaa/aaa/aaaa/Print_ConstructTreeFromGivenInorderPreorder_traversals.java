...
public class Print_ConstructTreeFromGivenInorderPreorder_traversals {
...
public static void main (String[] args)
{
	...
	Print_ConstructTreeFromGivenInorderPreorder_traversals.root=buldTreeWrap(in, pre, len);
