	...
	public static void findMaxSum(int[][] arr,int M,int N){
		...
		for(int left=0;left<N;left++){
			...
			for(int right=left;right<N;right++){
				...
				System.out.println(Arrays.toString(dp)+":currMaxSum:"+currMaxSum+":globalMaxSum:"+globalMaxSum+":finalLeft:"+finalLeft);
				System.out.println(":finalRight:"+finalRight+":finalTop:"+finalTop+":finalBottom:"+finalBottom);
			}
		}
