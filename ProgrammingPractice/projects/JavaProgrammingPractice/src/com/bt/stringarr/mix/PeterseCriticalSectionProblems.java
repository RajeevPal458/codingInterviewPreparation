...
public class PeterseCriticalSectionProblems {
	int turn;
    ...
    public PeterseCriticalSectionProblems(){
        ...
        public static void main(String[] args){
        	PeterseCriticalSectionProblems cSec = new PeterseCriticalSectionProblems();
    }
}
